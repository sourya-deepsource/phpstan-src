...
class TestMap
{
     ...
     */
    public function iterator_map(iterable $iterator, callable $callback): iterable
    {
     ...
     */
    public function hash_to_alt_sequence(iterable $hash): iterable
    {
        foreach ($hash as $k => $v) {
            yield $k;
            yield $v;
     ...
     */
    public function hash_to_alt_sequence2(iterable $hash): iterable
    {
        foreach ($hash as $k => $v) {
            yield $k;
            yield $v;
